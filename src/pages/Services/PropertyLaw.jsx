...
import propertyLawImg from '../../assets/img/images/property-lawyers-in-chennai.webp';
import propertyTransaction from '../../assets/img/images/property-transaction.webp';
import propertyDisputeCourt from '../../assets/img/images/property-disputes-and-court.webp';
import propertyVerification from '../../assets/img/images/property-verification.webp';
...
const PropertyLaw = () => {
    ...
    const faqs = [
        ...
        },
        {
            ...
            answer: "A lawyer can handle a property case in Chennai by reviewing documents, preparing legal strategies and representing you to achieve a favorable outcome."
        },
        {
            question: "How do I choose the right property attorney near me?",
            answer: "When selecting a property attorney near me, consider their experience, knowledge of local property laws, and track record in handling similar cases."
        },
        {
            question: "What should I do if I face a property dispute in Chennai within my family?",
            answer: "If you face a property dispute within your family in Chennai, first gather all property documents and try to resolve the issue through discussion. If it doesn’t settle, consult a property lawyer to get a legal opinion and take the necessary legal steps to protect your rights."
        },
        {
        ...
        {
            question: "When should I consult a Property Lawyer in Chennai during a property transaction?",
            answer: "It is advisable to consult a lawyer before signing any agreement, making payments, or registering the property."
        },
        {
            question: "How can a Property Lawyer Chennai help with land acquisition matters?",
            answer: "They can review acquisition notices, compensation claims and represent clients in legal proceedings."
        }
    ];
            ...
            <div className="w-full px-6">
                <div className="bg-white dark:bg-gray-800 rounded-3xl p-8 lg:p-12 shadow-sm border border-gray-100 dark:border-gray-700">
                    <div className="space-y-10">
                        ...
                        {/* Section 3: MLawyer - Services Offered by Property Lawyers */}
                        <div className="space-y-8">
                            <div className="text-center max-w-3xl mx-auto">
                                <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">MLawyer - Services Offered by Property Lawyers</h2>
                                ...
                                {[
                                    {
                                        ...
                                        desc: (
                                            <span>
                                                Lawyers conduct thorough checks to confirm <a href="https://www.mlawyer.in/blog/importance-of-patta-chitta-complete-guide-for-property-owners" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline font-semibold">ownership</a> and identify any legal issues associated with the property. This process is crucial to avoid future disputes.
                                            </span>
                                        ),
                                        icon: <PiNotebook className="text-secondary text-3xl" />
                                    },
                                    {
                                        title: "2. Drafting and Reviewing Agreements",
                                        desc: "From sale deeds to lease agreements, legal experts ensure that all contracts are clear, enforceable, and legally valid.",
                                        icon: <PiSealCheck className="text-secondary text-3xl" />
                                    },
                                    {
                                        title: "3. Property Registration Assistance",
                                        desc: "They guide clients through the registration process, ensuring compliance with government regulations.",
                                        icon: <PiHouse className="text-secondary text-3xl" />
                                    },
                                    {
                                        title: "4. Handling Property Disputes",
                                        desc: "Legal professionals represent clients in resolving conflicts related to ownership, boundaries, or contractual disagreements.",
                                        icon: <PiWarning className="text-secondary text-3xl" />
                                    },
                                    {
                                        title: "5. Legal Consultation and Opinions",
                                        desc: "Providing a detailed property legal opinion helps clients make informed decisions before proceeding with transactions.",
                        ...
                        <div className="text-center max-w-4xl mx-auto space-y-8">
                            <div>
                                ...
                                <div className="flex flex-wrap justify-center gap-6 mb-6">
                                    {[
                                        ...
                                        "Offering practical legal strategies",
                                        "Providing continuous support throughout the process"
                                    ].map((strat, idx) => (
                                        <div key={idx} className="flex items-center gap-2 px-4 py-2 bg-gray-50 dark:bg-gray-900 rounded-full border border-gray-100 dark:border-gray-700 text-gray-700 dark:text-gray-300 font-medium">
                                            <PiSealCheck className="text-primary text-xl shrink-0" />
                                            <span>{strat}</span>
                                        </div>
                                    ))}
                                </div>
                            ...
                            <div className="pt-6">
                                <h3 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Choose MLawyer for Best Property Lawyer in Chennai</h3>
                                <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
