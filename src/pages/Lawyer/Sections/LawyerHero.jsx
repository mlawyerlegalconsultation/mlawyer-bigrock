                ...
                <div className="max-w-4xl mx-auto space-y-8">
                    <PopIn>
                        <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-full shadow-sm border border-teal-100 dark:border-gray-700 mb-4 animate-fade-in-up transition-colors duration-300">
                            ...
                            <span className="text-sm font-medium text-primary dark:text-white transition-colors duration-300">{hero.badge}</span>
                        </div>
                    ...
                    <PopIn delay={0.1}>
                        <p className="text-xl text-primary/80 dark:text-gray-300 leading-relaxed max-w-2xl mx-auto transition-colors duration-300">
                            {hero.subtitle}
                        </p>
                    </PopIn>
                    <PopIn delay={0.2}>
